                ...
                ScrollViewReader(content: { proxy in
                    ...
                    .onChange(of: selectedIcon, perform: { value in
                        if value == "plus.circle" {
                            withAnimation {
                                proxy.scrollTo(getExerciseListTwo(muscleGroup: selectedMuscle).last, anchor: .trailing)
                            }
                        }
                    })
                    .onChange(of: selectedIcon, perform: { value in
                        if value == "trash.circle" || value == "pencil.circle" {
                            withAnimation(.spring()) {
                                proxy.scrollTo(getExerciseListTwo(muscleGroup: selectedMuscle).first, anchor: .leading)
                            }
                        }
                    })
                })
